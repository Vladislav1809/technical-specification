...
folder are mapped to the application's root namespace, 'task_schedule'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'task_schedule' in the same way
as `"task_schedule/sass/src"`.
